        ...
        loop {
            ...
            terminal.draw(|f| {
                ...
                match tab_cmd.unwrap() {
                    0 => {
                        let items = [
                            ListItem::new("> Create New User"),
                            ListItem::new("  --------------------------------------"),
                            ListItem::new("> Change Password"),
                            ListItem::new("> User Profile"),
                            ListItem::new("> Logout"),
                        ];
                    ...
                    1 => {
                        let items = [
                            ListItem::new("Add New Employee"),
                            ListItem::new("View Employee Details"),
                        ];
                        let list = List::new(items)
                            .block(
                                Block::default()
                    ...
                    2 => {
                        let items = [
                            ListItem::new("Add Bank Details"),
                            ListItem::new("Get Salary Details"),
                        ];
                        let list = List::new(items)
