    ...
    impl Person {
        pub fn new() -> Self {
            ...
            Person {
                ...
                pri_contact_no: match pri_contact_no.to_string().trim_end_matches("\r\n").to_string().len() {
                    0 => None,
                    _ => Some(pri_contact_no.to_string().trim_end_matches("\r\n").to_string())
                },

                sec_contact_no: match sec_contact_no.to_string().trim_end_matches("\r\n").to_string().len() {
                    0 => None,
                    _ => Some(sec_contact_no.to_string().trim_end_matches("\r\n").to_string())
                },

                personal_email: match personal_email.to_string().trim_end_matches("\r\n").to_string().len() {
                    0 => None,
                    _ => Some(personal_email.to_string().trim_end_matches("\r\n").to_string())
                },

                per_address: per_address.to_string()
                                .trim_end_matches("\r\n")
                                .to_string(),

                com_address: match com_address.to_string().trim_end_matches("\r\n").to_string().len() {
                    0 => None,
                ...
                uidai: uidai.to_string().trim_end_matches("\r\n").to_string().parse().unwrap(),

                uan: match uan.to_string().trim_end_matches("\r\n").to_string().len() {
                    0 => None,
                    _ => Some(uan.to_string().trim_end_matches("\r\n").to_string().parse().unwrap())
                },
            }
        }
